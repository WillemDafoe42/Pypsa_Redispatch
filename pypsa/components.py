...
# import modules for optimal power flow
from .opf import network_lopf, network_opf

# import modules for market simulation
# from .opf_market import network_lopf_market, network_opf_market
...
#    lopf = network_lopf
    ...
    def lopf(self, snapshots=None, pyomo=True, solver_name="glpk",
             solver_options={}, solver_logfile=None, formulation="kirchhoff", mode = "market",
